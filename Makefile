...
pkgdatadir = $(datadir)/bankitz
pkgincludedir = $(includedir)/bankitz
pkglibdir = $(libdir)/bankitz
pkglibexecdir = $(libexecdir)/bankitz
...
CONFIG_HEADER = $(top_builddir)/src/config/bankitz-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/bankitz-config.h.in \
...
ACLOCAL = ${SHELL} /home/wachi/public/dev2/bankitz/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/wachi/public/dev2/bankitz/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/wachi/public/dev2/bankitz/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/wachi/public/dev2/bankitz/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/wachi/public/dev2/bankitz/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = bankitz
PACKAGE_BUGREPORT = http://www.bankitz.online
PACKAGE_NAME = BanKitt Core
PACKAGE_STRING = BanKitt Core 3.0.0
PACKAGE_TARNAME = bankitz
PACKAGE_URL = 
...
X11XCB_CFLAGS = 
X11XCB_LIBS = 
XGETTEXT = /opt/lampp/bin/xgettext
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/wachi/public/dev2/bankitz
abs_srcdir = /home/wachi/public/dev2/bankitz
abs_top_builddir = /home/wachi/public/dev2/bankitz
abs_top_srcdir = /home/wachi/public/dev2/bankitz
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/wachi/public/dev2/bankitz/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/bankitzd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/bankitz-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/bankitz-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = BanKitt-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_bankitz_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_bankitz_coverage.info test_bankitz.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/BanKitt-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/bankitz-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/bankitz-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/bankitz-config.h
$(top_srcdir)/src/config/bankitz-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/bankitz-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/BanKitt-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BanKitt-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BanKitt-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_bankitz.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_bankitz -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_bankitz_filtered.info: test_bankitz.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_bankitz_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_bankitz_coverage.info: baseline_filtered_combined.info test_bankitz_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_bankitz_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_bankitz_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_bankitz_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_bankitz.coverage/.dirstamp:  test_bankitz_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_bankitz.coverage/.dirstamp total.coverage/.dirstamp

# BanKitt: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_bankitz.coverage/ total.coverage/ $(OSX_APP)
