...
In order to support loading of multiple wallets in bankitz-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bankitz.cpp.
...
Changes to bankitz.cpp
----------------------
bankitz.cpp is the entry point into bankitz-qt, and as such, will require some minor modifications to provide hooks for
