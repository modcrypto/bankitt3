...
!define COMPANY "BanKitt Core project"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-bankitz executable and locales:
    Delete /REBOOTOK $INSTDIR\bankitz.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\bankitz-qt.exe
    ...
    WriteRegStr HKCR "bankitz" "URL Protocol" ""
    WriteRegStr HKCR "bankitz" "" "URL:BKZ"
    WriteRegStr HKCR "bankitz\DefaultIcon" "" $INSTDIR\bankitz-qt.exe
    WriteRegStr HKCR "bankitz\shell\open\command" "" '"$INSTDIR\bankitz-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\bankitz-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\BKZ.lnk"
