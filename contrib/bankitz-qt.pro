...
RESOURCES += src/qt/bankitz.qrc src/qt/bankitz_locale.qrc

TRANSLATIONS += src/qt/locale/bankitz_bg.ts \
                src/qt/locale/bankitz_de.ts \
                src/qt/locale/bankitz_en.ts \
                src/qt/locale/bankitz_es.ts \
                src/qt/locale/bankitz_fi.ts \
                src/qt/locale/bankitz_fr.ts \
                src/qt/locale/bankitz_it.ts \
                src/qt/locale/bankitz_ja.ts \
                src/qt/locale/bankitz_pl.ts \
                src/qt/locale/bankitz_pt.ts \
                src/qt/locale/bankitz_ru.ts \
                src/qt/locale/bankitz_sk.ts \
                src/qt/locale/bankitz_sv.ts \
                src/qt/locale/bankitz_vi.ts \
                src/qt/locale/bankitz_zh_CN.ts \
                src/qt/locale/bankitz_zh_TW.ts
