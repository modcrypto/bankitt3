...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BanKitz Core bankitz-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bankitz-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bankitz transaction") + "\n" +
                               "  bankitz-tx [options] -create [commands]   " + _("Create hex-encoded bankitz transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bankitz transaction
