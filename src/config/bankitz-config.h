/* src/config/bankitz-config.h.  Generated from bankitz-config.h.in by configure.  */
/* src/config/bankitz-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://www.bankitz.online"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BanKitz Community"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BanKitz Community 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bankitz"
