...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "BanKitz server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BKZ features */
        {"bankitz", "masternode", &masternode, true, true, false},
        {"bankitz", "masternodelist", &masternodelist, true, true, false},
        {"bankitz", "mnbudget", &mnbudget, true, true, false},
        {"bankitz", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"bankitz", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bankitz", "mnsync", &mnsync, true, true, false},
        {"bankitz", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"bankitz", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bankitzd, or the -server option to bankitz-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"BanKitz Alert\" admin@foo.com\n"),
...
{
    return "> bankitz-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2213/\n";
}
