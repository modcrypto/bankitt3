...
/** Utility functions used by the BKZ Qt UI.
 */
namespace GUIUtil
{
...
// Render BKZ addresses in monospace font
...
// Parse "bankitz:" URI into recipient object, return true on successful parsing
