                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BanKitz-Community Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BanKitz address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bankitz: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BanKitz Core"), this);
    aboutAction->setStatusTip(tr("Show information about BanKitz Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BanKitz"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BanKitz addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BanKitz addresses"));
    ...
    openAction->setStatusTip(tr("Open a BanKitz: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BanKitz Core help message to get a list with possible BanKitz command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BanKitz Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BanKitz network", "", count));
}
...
{
    QString strTitle = tr("BanKitz Core"); // default title
