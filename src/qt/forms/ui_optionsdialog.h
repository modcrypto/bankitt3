...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeBKZ = new QSpinBox(tabMain);
        anonymizeBKZ->setObjectName(QStringLiteral("anonymizeBKZ"));
        anonymizeBKZ->setMinimum(100);
        anonymizeBKZ->setMaximum(100000);
        anonymizeBKZ->setSingleStep(100);
        anonymizeBKZ->setValue(1000);

        horizontalLayout->addWidget(anonymizeBKZ);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start BKZ after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start BKZ on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of BKZ to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the BKZ client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the BKZ network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting BKZ.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/bankitz-project/bankitz-project-translations", 0));
