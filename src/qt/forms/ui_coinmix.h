...
public:
    ...
    void retranslateUi(QWidget *Coinmix)
    {
        ...
        labelAmountRounds->setText(QApplication::translate("Coinmix", "0 BKZ / 0 Rounds", 0));
...
#ifndef QT_NO_TOOLTIP
        labelDarksendSyncStatus->setToolTip(QApplication::translate("Coinmix", "The displayed information may be out of date. Your wallet automatically synchronizes with the BKZ network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
