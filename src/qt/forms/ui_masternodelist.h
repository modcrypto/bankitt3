...
public:
    ...
    void setupUi(QWidget *MasternodeList)
    {
        ...
        if (tableWidgetMasternodes->columnCount() < 7)
            tableWidgetMasternodes->setColumnCount(7);
    ...
    void retranslateUi(QWidget *MasternodeList)
    {
        ...
        ___qtablewidgetitem7->setText(QApplication::translate("MasternodeList", "Collateral", 0));
        ...
        ___qtablewidgetitem12->setText(QApplication::translate("MasternodeList", "Last Seen (UTC)", 0));
        QTableWidgetItem *___qtablewidgetitem13 = tableWidgetMasternodes->horizontalHeaderItem(5);
        ___qtablewidgetitem13->setText(QApplication::translate("MasternodeList", "Pubkey", 0));
        QTableWidgetItem *___qtablewidgetitem14 = tableWidgetMasternodes->horizontalHeaderItem(6);
        ___qtablewidgetitem14->setText(QApplication::translate("MasternodeList", "Collateral", 0));
